/*
*
*   Anope XML Database Convertor Version 1.1
*
...
int main(int argc, char *argv[]) {
	...
	if ((in = fopen("ns_uuid.db", "r")) != NULL) {
		while (fgets(buffer, 1500, in)) {
			uuidnick = myStrGetToken(buffer, ' ', 0);
